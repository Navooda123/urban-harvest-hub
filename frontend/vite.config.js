...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ['favicon.svg', 'favicon.ico', 'apple-touch-icon.png', 'offline.html'],
      manifest: {
      ...
      workbox: {
        // Network-first for API calls — ensures freshest data, falls back to cache
        runtimeCaching: [
          {
            urlPattern: /\/api\/.*/i,
          ...
          // Stale-while-revalidate for OpenWeatherMap icons
          {
